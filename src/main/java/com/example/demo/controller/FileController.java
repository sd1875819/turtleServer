...
public class FileController {
    ...
    public Result<?> upload(MultipartFile file) throws IOException {  /*MultipartFile file用于接收前台传过来的文件数据对象*/
        ...
        //首先通过System.getProperty("user.dir")获取Springboot这个工程的路径地址，再拼接上files文件夹的路径及文件的路径，即是文件存储的绝对路径
        String rootFilePath = System.getProperty("user.dir") + "/turtleServer/src/main/resources/files/" + originalFilename;
